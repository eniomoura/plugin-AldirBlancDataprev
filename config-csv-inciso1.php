...
return [ //Configuração dos campos
    "CPF" => env('INC1_CSV_CPF', 'field_30'),
    "SEXO" => env('INC1_CSV_SEXO', 'field_17'),
    "FLAG_CAD_ESTADUAL" => 1,
    ...
    "FLAG_ATUACAO_ARTES_CENICAS" => env('INC1_CSV_FLAG_ATUACAO_ARTES_CENICAS', 'field_10'),
    "FLAG_ATUACAO_AUDIOVISUAL" => env('INC1_CSV_FLAG_ATUACAO_AUDIOVISUAL', 'field_10'),
    "FLAG_ATUACAO_MUSICA" => env('INC1_CSV_FLAG_ATUACAO_MUSICA', 'field_10'),
    "FLAG_ATUACAO_ARTES_VISUAIS" => env('INC1_CSV_FLAG_ATUACAO_ARTES_VISUAIS', 'field_10'),
    "FLAG_ATUACAO_PATRIMONIO_CULTURAL" => env('INC1_CSV_FLAG_ATUACAO_PATRIMONIO_CULTURAL', 'field_10'),
    "FLAG_ATUACAO_MUSEUS_MEMORIA" => env('INC1_CSV_FLAG_ATUACAO_MUSEUS_MEMORIA', 'field_10'),
    "FLAG_ATUACAO_HUMANIDADES" => env('INC1_CSV_FLAG_ATUACAO_HUMANIDADES', 'field_10'),
    "FAMILIARCPF" => env('INC1_CSV_FAMILIARCPF', 'field_5'),
    "GRAUPARENTESCO" => env('INC1_CSV_GRAUPARENTESCO', 'field_5'),
